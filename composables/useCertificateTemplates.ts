...
export const AVAILABLE_SOURCES: Array<{ value: string; label: string; type: MappingItem['type'] }> = [
  ...
  { value: 'section_score.Listening', label: 'Skor Listening (Individual)', type: 'text' },
  { value: 'section_score.Structure', label: 'Skor Structure (Individual)', type: 'text' },
  { value: 'section_score.Reading',   label: 'Skor Reading (Individual)',   type: 'text' },
